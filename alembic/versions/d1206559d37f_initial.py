...
Revision ID: d1206559d37f
Revises: 
Create Date: 2025-11-25 22:04:18.709421
...
def upgrade() -> None:
    ...
    sa.Column('tipo_admin', sa.String(length=30), nullable=False),
    ...
    sa.Column('motivo_bloqueio', sa.String(length=255), nullable=True),
    sa.ForeignKeyConstraint(['estudio_id'], ['estudios.id'], ),
    sa.ForeignKeyConstraint(['professor_id'], ['professores.id'], ),
    sa.ForeignKeyConstraint(['substituto_id'], ['professores.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
